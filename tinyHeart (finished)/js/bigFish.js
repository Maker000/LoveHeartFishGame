...
momObj.prototype.draw = function(){
	//鱼随鼠标移动
	this.x = lerpDistance(mx,this.x,0.956);//使用了com里面的封装好的方法，后面的趋近前面的，mx是变化的
	this.y = lerpDistance(my,this.y,0.956);
	//鱼随鼠标旋转
	...
	this.angle = lerpAngle(beta,this.angle,0.68);//返回趋近角度
	//大鱼摇尾巴
